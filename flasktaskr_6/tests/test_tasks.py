...
#helper
    ...
    def create_admin_user(self):
        ...
        password=bcrypt.generate_password_hash('superuser123'),
        role='admin')
        db.session.add(new_user)
        db.session.commit()
#Tests
    ...
    def test_admin_users_can_complete_tasks_are_not_created_by_them(self):
        self.create_user('Michael','michael@realpython.com','python')
        self.login('Michael','python')
        self.app.get('tasks/',follow_redirects=True)
        self.create_task()
        ...
        self.login('Superuser','superuser123')
        self.app.get('tasks/',follow_redirects=True)
        response=self.app.get('complete/1/',follow_redirects=True)
        self.assertNotIn(
        b'You can only update tasks that belong to you.',response.data)

    def test_admin_users_can_delete_tasks_are_not_created_by_them(self):
        self.create_user('Michael','michael@realpython.com','python')
        self.login('Michael','python')
        self.app.get('tasks/',follow_redirects=True)
        self.create_task()
    ...
    def test_users_cannot_see_task_modify_links_for_tasks_created_by_them(self):
