...
#Tests
    ...
    def test_logged_in_users_can_logout(self):
        ...
        response=(b'Goodbye!',response.data)
    ...
    def test_duplicate_user_registeration_throws_error(self):
        self.register('Emmanuel','emmanuel@realpython.com','emmanuel123','emmanuel123')
        response=self.register('Emmanuel','emmanuel@realpython.com','emmanuel123','emmanuel123')
    ...
    def test_string_representation_of_the_user_object(self):
        ...
        for user in users:
            self.assertEqual(user.name,'Annuarita')

        def test_default_user_roel(self):
            db.session.add(User('Annuarita','annuarita@edu.com','annuarita123'))
            users=db.session.query(User).all()
            for user in users:
